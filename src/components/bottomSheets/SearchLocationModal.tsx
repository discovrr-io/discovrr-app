...
function SearchLocationModalBackdrop(props: BottomSheetBackdropProps) {
...
const SearchLocationModal = React.forwardRef<BottomSheetModal>((props, ref) => {
    ...
    <BottomSheetModal
      ...
      <View
        ...
        <View>
          ...
          <View style={{ borderBottomWidth: 1, borderColor: colors.gray200 }} />
        </View>
        <View
          style={{
            flexGrow: 1,
