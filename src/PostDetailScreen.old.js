...
class PostDetailScreen extends Component {
  constructor(props) {
    ...
    if (this.postDetails) {
      if (this.postDetails.__refactored) {
        this.postDetails.avatar = this.postDetails.author.avatar;
        this.postDetails.name = this.postDetails.author.name;

        this.postDetails.hasMedia = this.postDetails.postType !== 'TEXT';
        this.postDetails.isVideo = this.postDetails.postType === 'VIDEO';
        this.postDetails.width = this.postDetails.dimensions.width;
        this.postDetails.height = this.postDetails.dimensions.height;
      }
                  ...
                  <TouchableOpacity style={{ backgroundColor: 'red' }}>
                    <View
                      ...
                      <TouchableOpacity
                        ...
                        disabled
                        onPress={() =>
                          this.showProfileDetails(this.postDetails.user)
                        }>
                      ...
                      <TouchableOpacity
                        activeOpacity={0.8}
                        disabled
                        onPress={this.showProfileDetails(
                          this.postDetails.user,
                        )}>
                        <Text
                          allowFontScaling={false}
                          numberOfLines={2}
