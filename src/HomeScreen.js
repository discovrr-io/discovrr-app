...
class HomeScreen extends Component {
  constructor(props) {
    ...
    ({
      ...
      route: {
        params: {
          postTypes: this.postTypes = 'posts',
        } = {},
      } = {},
    } = props);
    ...
    try {
      ...
      if (this.postTypes === 'nearMePosts') {
        ...
        if (locationPreference) {
          pointOfInterest = new Parse.GeoPoint(locationPreference.latitude, locationPreference.longitude);
          query.withinKilometers(geoPoint, pointOfInterest, locationPreference.searchRadius);
      ...
      if (Array.isArray(results) && results.length) {
        ...
        const items = results.map((item) => {
          ...
          if (this.postTypes === 'nearMePosts') {
            ...
            distance = (item.get(geoPoint).kilometersTo(pointOfInterest)).toFixed(1);
          ...
          if (isDevMode && false && item.id === 'pdXpEdP36a') {
            ...
            poster = imageUrl;
            imageUrl = 'https://firebasestorage.googleapis.com/v0/b/discovrr-uat.appspot.com/o/post%2Fenjaga_hphlo635cxt.jpg?alt=media&token=5d7c8146-b636-498e-80e6-8e145f70567a';
            source = { uri: 'https://firebasestorage.googleapis.com/v0/b/discovrr-uat.appspot.com/o/post%2Fenjaga_hphlo635cxt.jpg?alt=media&token=5d7c8146-b636-498e-80e6-8e145f70567a' };

            images[0].type = 'video';
            images[0].url = 'https://firebasestorage.googleapis.com/v0/b/discovrr-uat.appspot.com/o/post%2Fenjaga_hphlo635cxt.jpg?alt=media&token=5d7c8146-b636-498e-80e6-8e145f70567a';
          }
        ...
        switch (this.postTypes) { // enjagaNet
          case 'posts':
      ...
      this.bottomSheetEmitter.emit(
        'showPanel',
        {
          ...
          onFinish: (data, hasPinned) => {
            ...
            const newPinnedPosts = Array.isArray(pinnedPosts) ? [...pinnedPosts] : [];
